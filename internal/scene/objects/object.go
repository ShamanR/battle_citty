...
type Object struct {
	...
	// bounds and pos
	pos         pixel.Vec
	orientation consts2.Orientation
...
func NewObject(ID int64, scene interfaces.Scene, objectType consts2.ObjectType, pos *pixel.Vec, spriteList *interfaces.SceneObjectAnimateList) *Object {
	obj := Object{
		...
		bounds: pixel.Rect{
			Min: pixel.Vec{0, 0},
			Max: pixel.Vec{16 * consts2.ScaleSprites, 16 * consts2.ScaleSprites},
		},
		children: []interfaces.SceneObject{},
	}
	obj.SetPos(pos)
...
func (o *Object) Draw(target pixel.Target) {
	...
	if o.objectType == consts2.ObjectTypeProjectile {
		//fmt.Println("here")
	}
...
func (o *Object) SetScale(scale pixel.Vec) {
	o.scale = scale
	o.bounds = pixel.R(0, 0, consts2.MapTileSize*scale.X, consts2.MapTileSize*scale.Y)
}
